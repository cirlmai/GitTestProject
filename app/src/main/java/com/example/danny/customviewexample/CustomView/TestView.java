package com.example.danny.customviewexample.CustomView;
...
import com.example.danny.customviewexample.R;


/**
 * Created by danny on 2016/12/14.
 */
...
public class TestView extends ViewGroup {
    ...
    public interface OnCurrentItemChangedListener {
        void OnCurrentItemChanged(TestView source, int currentItem);
    }

    /**
     * Class constructor taking only a context. Use this constructor to create
     * {@link TestView} objects from your own code.
     *
     * @param context
     */
     ...
     * is used by the layout engine to construct a {@link TestView} from a set of
     * XML attributes.
     *
     * @param context
     * @param attrs   An attribute set which can contain attributes from
     *                {@link com.example.danny.customviewexample.R.styleable} as well as attributes inherited
    ...
    public TestView(Context context, AttributeSet attrs) {
        ...
        //
        // This call uses R.styleable.TestView, which is an array of
        ...
        try {
            ...
            //
            // The R.styleable.TestView_* constants represent the index for
            // each custom attribute in the R.styleable.TestView array.
            mShowText = a.getBoolean(R.styleable.TestView_showText, false);
            mTextY = a.getDimension(R.styleable.TestView_labelY, 0.0f);
            mTextWidth = a.getDimension(R.styleable.TestView_labelWidth, 0.0f);
            mTextHeight = a.getDimension(R.styleable.TestView_labelHeight, 0.0f);
            mTextPos = a.getInteger(R.styleable.TestView_labelPosition, 0);
            mTextColor = a.getColor(R.styleable.TestView_labelColor, 0xff000000);
            mHighlightStrength = a.getFloat(R.styleable.TestView_highlightStrength, 1.0f);
            mPieRotation = a.getInt(R.styleable.TestView_pieRotation, 0);
            mPointerRadius = a.getDimension(R.styleable.TestView_pointerRadius, 2.0f);
            mAutoCenterInSlice = a.getBoolean(R.styleable.TestView_autoCenterPointerInSlice, false);
        } finally {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // on this view's children. TestView lays out its children in onSizeChanged().
    }
